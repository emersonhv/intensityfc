          ...
          <table class="table table-bordered table-hover">
              ...
              <tr ng-repeat="plan in planes | filter:nombrecl">
                  <td>
                      ...
                      <a id="plan{{$index+1}}" name="plan" value="{{plan.id}}" class="label btn-info" href="ver_planes/{{ plan.id }}">Ver Plan</a>
                      <a id="plan{{$index+1}}" name="plan" value="{{plan.id}}" class="label btn-info" href="ver_planes/{{ plan.id }}">Editar</a>
                  </td>
                  <td><a>{{plan.name}}</a></td>
