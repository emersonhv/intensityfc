            ...
            <div class="modal" id="nueva_cita" tabindex="-1" role="dialog">
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-body">
                        <!-- Drop down Clientes -->
                        <label>Cliente</label>
                        <select class="form-control select2" id="cbxClientes" style="width: 100%;" ng-model="clientes.model">
                            <option ng-repeat="cliente in clientes.cliente_lista" value="{{cliente.id}}" >{{ cliente.name }}</option>
                        </select>
